...
/**
 * \brief Create the jlink65c02 page.
 *
 ...
 */
int project_jlink65c02_index(page_context* context, FILE* output)
{
    int retval;

    WRITE_FILE(done, "static-site/projects/jlink65c02/index.html", {
        PAGE_TITLE(done, "danger.farm jlink65c02 project", {
            PAGE_URL(done, "https://danger.farm/projects/jlink65c02/", {
                PAGE_SITE_NAME(done, "danger.farm", {
                    PAGE_SITE_DESCRIPTION(done,
                        "The jlink65c02 linker project.", {
                        WRAP_TEMPLATE(done, {
...
int main_content(page_context* context, FILE* out)
{
    ...
    XH1(done, {
        XTEXT(done, "The jlink65c02 Linker");
        XSUCCESS();
    });
